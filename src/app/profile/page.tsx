...
import { Home, BarChart3, CreditCard, RefreshCw, Clock, Users, Settings, CheckCircle2, Info, Share } from 'lucide-react';
                      ...
                      <CardContent className="space-y-6 border border-gra-50 shadow p-6 rounded-lg">
                        <div>
                          <Select
                            ...
                            onSelectionChange={(key) => setTitle(key as string)}
                          >
                            {(item) => (
                              <Select.Item key={item.id} id={item.id}>
                                {item.label}
                        ...
                        <div>
                          <Select
                            ...
                            onSelectionChange={(key) => setRace(key as string)}
                          >
                            {(item) => (
                              <Select.Item key={item.id} id={item.id}>
                                {item.label}

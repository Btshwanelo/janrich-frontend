  ...
  return (
    <AriaGroup
      ...
      className={({ isFocusWithin, isDisabled, isInvalid }) =>
        cx(
          ...
          isFocusWithin && !isDisabled && "ring-2 ring-primary-500",
          ...
          isInvalid && "ring-primary-500",
          "group-invalid:ring-primary-500",
    ...
    >
      ...
      <AriaInput
        ...
        className={cx(
          "m-0 w-full bg-transparent text-md text-primary ring-0 rounded-lg outline-hidden placeholder:text-placeholder autofill:rounded-lg autofill:text-primary",

...
export const styles = sortCx({
    ...
    colors: {
        ...
        secondary: {
            root: [
                "bg-primary text-secondary shadow-xs-skeumorphic ring-1 ring-border-inactive ring-inset hover:bg-primary_hover hover:text-secondary_hover data-loading:bg-primary_hover focus-visible:ring-2 focus-visible:ring-primary-500",
                // Disabled styles

...
export const PayoutModal: React.FC<PayoutModalProps> = ({
  ...
  const [selectedBankingOption, setSelectedBankingOption] =
  ...
  const handleRequestPayout = async () => {
    ...
    if (payoutType === "full") {
      ...
      if (!amount || amount.trim() === "") {
        ...
        // Check if amount exceeds balance
          ...
          errors.amount = `You cannot withdraw more than your available balance of ${amountConversion(
            totalBalance
          )}.`;
        } else {
    ...
    if (
      ...
      setErrorMessage(
        "Existing banking details are incomplete. Please add new banking details."
      );
      return;
    }
    ...
    try {
      ...
      setSuccessMessage(
        `Your ${payoutType} withdrawal request of ${amountConversion(
          payoutAmount
            ...
            {errorMessage && (
              <div className="mb-6">
                <div className="bg-error-50 border border-error-200 rounded-lg p-3 flex items-start justify-between gap-3">
                  <p className="text-error-600 text-sm flex-1">
                    {errorMessage}
                  </p>
                  <button
                    type="button"
                ...
                <div className="mb-6">
                  ...
                  <Select
                    ...
                    onSelectionChange={(key) =>
                      setSelectedBankingOption(key as string)
                    }
                  ...
                  {selectedBankingOption === "existing" ? (
                    <div className="bg-gray-50 rounded-lg p-4 space-y-2">
                      {isProfileLoading ? (
                        ...
                        <p className="text-sm text-gray-500">
                          No banking details found. Please select "Add new
                          account" to enter banking details.
                        </p>
                      )}
                    </div>
                  ) : (
